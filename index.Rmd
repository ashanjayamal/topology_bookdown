...
Note that basis element in lower limit toplogy is **not** open in the standard toplogy. But otherway around is very true. As an example, $$(1,2)=\bigcup_{n\in \mathbb{N}}[1+\frac{1}{n},2).$$ Clearly left hand side is open in lower limit topology by T2.
...
```{proposition}
Let $X$ be a Hausdorff space and $A\subset X$\
